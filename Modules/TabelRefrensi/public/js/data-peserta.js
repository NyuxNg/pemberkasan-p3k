$(document).ready(function() {
    ...
    var dataTableDefault = $('#dataTableDefault').DataTable({
        ...
        columns: [
            ...
            { data: 'no_peserta', name: 'no_peserta', className: 'w-15 text-center text-nowrap align-middle' },
            ...
            { data: 'pendidikan', name: 'pendidikan', className: 'text-nowrap align-middle' },
            { data: 'unit_penempatan', name: 'unit_penempatan', className: 'text-nowrap align-middle' },
