$(document).ready(function() {
    ...
    var dataTableDefault = $('#dataTableDefault').DataTable({
        ...
        columns: [
            ...
            { data: 'nik', name: 'nik', className: 'text-nowrap align-middle' },
            ...
            { data: 'pekerjaan', name: 'pekerjaan', className: 'text-center text-nowrap align-middle' },
            { data: 'akte_nikah_tanggal', name: 'akte_nikah_tanggal', className: 'text-nowrap align-middle' },
            { data: 'status_hidup', name: 'status_hidup', className: 'text-nowrap align-middle' },
