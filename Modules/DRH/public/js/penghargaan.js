$(document).ready(function() {
    ...
    var dataTableDefault = $('#dataTableDefault').DataTable({
        ...
        columns: [
            ...
            { data: 'tahun_perolehan', name: 'tahun_perolehan', className: 'text-center text-nowrap align-middle' },
            { data: 'instansi_pemberi', name: 'instansi_pemberi', className: 'text-nowrap align-middle' },
