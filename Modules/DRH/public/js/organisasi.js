$(document).ready(function() {
    ...
    var dataTableDefault = $('#dataTableDefault').DataTable({
        ...
        columns: [
            ...
            { data: 'mulai', name: 'mulai', className: 'text-center text-nowrap align-middle' },
            { data: 'selesai', name: 'selesai', className: 'text-center text-nowrap align-middle' },
            { data: 'pimpinan', name: 'pimpinan', className: 'text-nowrap align-middle' },
