$(document).ready(function() {
    ...
    var dataTableDefault = $('#dataTableDefault').DataTable({
        ...
        columns: [
            ...
            { data: 'nomor', name: 'nomor', className: 'text-nowrap align-middle' },
            { data: 'tanggal', name: 'tanggal', className: 'text-nowrap align-middle' },
            { data: 'pejabat', name: 'pejabat', className: 'text-nowrap align-middle' },
